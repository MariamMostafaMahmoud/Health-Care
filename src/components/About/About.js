...
import './_about.scss';
// images
import photoOne from '../../assets/girl1.jpg';
import photoTwo from '../../assets/people.jpg';
import photoThree from '../../assets/people3.jpg';
        ...
        <>
            <section className="about-sec">
                <div className="container">
                    <div className="row ">
                        <div className="col-lg-6 mb-30 photos row">
                            <div className="col-6 about-photo1"><img src={photoTwo} /></div>
                            <div className="col-6 about-photo2"><img src={photoOne} /></div>
                            <div className="col-6 about-photo3 "><img src={photoThree} /></div>
                            <div className="contant col-6 mt-2">
                                <span className="mt-5">20</span>
                                <span>Year Experience</span>
                            </div>
                        </div>
                        <div className="col-lg-6 mb-30">
                            <div className="contantTwo">
                                <h6>About Us</h6>
                            ...
                            <div className="row d-flex flex-wrap">
                                <div className="col-lg-6 col-sm-6 mb-30 mb-sm-20 parent">
                                    <div className="d-flex align-items-center Emergency One">
